...
export async function updateLiquidityPoolAggregator(
  ...
  let updated: LiquidityPoolAggregator = {
    ...
    totalVotesDeposited:
      diff.incrementalTotalVotesDeposited ?? current.totalVotesDeposited,
    totalVotesDepositedUSD:
      diff.incrementalTotalVotesDepositedUSD ?? current.totalVotesDepositedUSD,
    ...
    veNFTamountStaked:
      diff.incrementalVeNFTamountStaked !== undefined
        ? diff.incrementalVeNFTamountStaked
